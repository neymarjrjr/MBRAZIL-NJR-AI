...
const botname = process.env.BOTNAME || 'MBRAZIL-NJR-AI';
const antibot = process.env.ANTIBOT || 'FALSE';
const author = process.env.STICKER_AUTHOR ||'MBRAZIL';
const packname = process.env.STICKER_PACKNAME || 'MBRAZIL';
const antitag = process.env.ANTITAG || 'FALSE';
const dev = process.env.DEV || '255676787885';
